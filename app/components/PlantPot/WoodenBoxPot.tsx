...
const WoodenBoxPot: React.FC<WoodenBoxPotProps> = ({ children, maxCols }) => {
  return (
    ...
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[48.5%] w-clamp-79vw aspect-square">
        <img className="w-full" src="/assets/images/pot/woodenBoxPot.png" alt="木箱の鉢" />
      </div>
