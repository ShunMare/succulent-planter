...
const LightBrownPot: React.FC<LightBrownPotProps> = ({ children, maxCols }) => {
  return (
    ...
    >
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-clamp-44vw aspect-square">
        <img className="w-full" src="/assets/images/pot/lightBrownPot.png" alt="明るい茶色い鉢" />
      </div>
